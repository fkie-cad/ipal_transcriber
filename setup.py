...
setup(
    ...
    scripts=["ipal-transcriber", "ipal-state-extractor"],
    ...
    keywords="industrial protocols networking security capture packets IDS CIP GOOSE Modbus S7 IEC 60870-5-104 NMEA0183 IEC 61162-450",
    classifiers=[
        "License :: MIT License",
